...
// checks if the GetContainerConfigPending200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContainerConfigPending200Response{}
...
func NewGetContainerConfigPending200Response() *GetContainerConfigPending200Response {
	this := GetContainerConfigPending200Response{}
	return &this
}
...
func (o *GetContainerConfigPending200Response) GetData() []GetContainerConfigPending200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetContainerConfigPending200ResponseDataInner
		return ret
	}
	return o.Data
}
...
type NullableGetContainerConfigPending200Response struct {
	value *GetContainerConfigPending200Response
	isSet bool
}

func (v NullableGetContainerConfigPending200Response) Get() *GetContainerConfigPending200Response {
	return v.value
}

func (v *NullableGetContainerConfigPending200Response) Set(val *GetContainerConfigPending200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContainerConfigPending200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContainerConfigPending200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContainerConfigPending200Response(val *GetContainerConfigPending200Response) *NullableGetContainerConfigPending200Response {
	return &NullableGetContainerConfigPending200Response{value: val, isSet: true}
}

func (v NullableGetContainerConfigPending200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContainerConfigPending200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
