...
// checks if the CreateVMRequestIde0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVMRequestIde0{}

// CreateVMRequestIde0 struct for CreateVMRequestIde0
type CreateVMRequestIde0 struct {
	// AIO type to use.
...
func (o CreateVMRequestIde0) MarshalJSON() ([]byte, error) {
...
func (o CreateVMRequestIde0) ToMap() (map[string]interface{}, error) {
...
type NullableCreateVMRequestIde0 struct {
	value *CreateVMRequestIde0
	isSet bool
}

func (v NullableCreateVMRequestIde0) Get() *CreateVMRequestIde0 {
	return v.value
}

func (v *NullableCreateVMRequestIde0) Set(val *CreateVMRequestIde0) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVMRequestIde0) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVMRequestIde0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVMRequestIde0(val *CreateVMRequestIde0) *NullableCreateVMRequestIde0 {
	return &NullableCreateVMRequestIde0{value: val, isSet: true}
}

func (v NullableCreateVMRequestIde0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVMRequestIde0) UnmarshalJSON(src []byte) error {
	v.isSet = true
