...
// checks if the GetVMConfig200ResponseDataScsi0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVMConfig200ResponseDataScsi0{}

// GetVMConfig200ResponseDataScsi0 struct for GetVMConfig200ResponseDataScsi0
type GetVMConfig200ResponseDataScsi0 struct {
	// AIO type to use.
...
func NewGetVMConfig200ResponseDataScsi0() *GetVMConfig200ResponseDataScsi0 {
	this := GetVMConfig200ResponseDataScsi0{}
	return &this
}
...
func (o GetVMConfig200ResponseDataScsi0) MarshalJSON() ([]byte, error) {
...
func (o GetVMConfig200ResponseDataScsi0) ToMap() (map[string]interface{}, error) {
...
type NullableGetVMConfig200ResponseDataScsi0 struct {
	value *GetVMConfig200ResponseDataScsi0
	isSet bool
}

func (v NullableGetVMConfig200ResponseDataScsi0) Get() *GetVMConfig200ResponseDataScsi0 {
	return v.value
}

func (v *NullableGetVMConfig200ResponseDataScsi0) Set(val *GetVMConfig200ResponseDataScsi0) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVMConfig200ResponseDataScsi0) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVMConfig200ResponseDataScsi0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVMConfig200ResponseDataScsi0(val *GetVMConfig200ResponseDataScsi0) *NullableGetVMConfig200ResponseDataScsi0 {
	return &NullableGetVMConfig200ResponseDataScsi0{value: val, isSet: true}
}

func (v NullableGetVMConfig200ResponseDataScsi0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVMConfig200ResponseDataScsi0) UnmarshalJSON(src []byte) error {
	v.isSet = true
