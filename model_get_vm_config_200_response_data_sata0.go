...
// checks if the GetVMConfig200ResponseDataSata0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVMConfig200ResponseDataSata0{}

// GetVMConfig200ResponseDataSata0 struct for GetVMConfig200ResponseDataSata0
type GetVMConfig200ResponseDataSata0 struct {
	// AIO type to use.
...
func NewGetVMConfig200ResponseDataSata0() *GetVMConfig200ResponseDataSata0 {
	this := GetVMConfig200ResponseDataSata0{}
	return &this
}
...
func (o GetVMConfig200ResponseDataSata0) MarshalJSON() ([]byte, error) {
...
func (o GetVMConfig200ResponseDataSata0) ToMap() (map[string]interface{}, error) {
...
type NullableGetVMConfig200ResponseDataSata0 struct {
	value *GetVMConfig200ResponseDataSata0
	isSet bool
}

func (v NullableGetVMConfig200ResponseDataSata0) Get() *GetVMConfig200ResponseDataSata0 {
	return v.value
}

func (v *NullableGetVMConfig200ResponseDataSata0) Set(val *GetVMConfig200ResponseDataSata0) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVMConfig200ResponseDataSata0) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVMConfig200ResponseDataSata0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVMConfig200ResponseDataSata0(val *GetVMConfig200ResponseDataSata0) *NullableGetVMConfig200ResponseDataSata0 {
	return &NullableGetVMConfig200ResponseDataSata0{value: val, isSet: true}
}

func (v NullableGetVMConfig200ResponseDataSata0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVMConfig200ResponseDataSata0) UnmarshalJSON(src []byte) error {
	v.isSet = true
