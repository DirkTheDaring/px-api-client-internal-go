...
// checks if the GetVMConfig200ResponseDataVirtio0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVMConfig200ResponseDataVirtio0{}

// GetVMConfig200ResponseDataVirtio0 struct for GetVMConfig200ResponseDataVirtio0
type GetVMConfig200ResponseDataVirtio0 struct {
	// AIO type to use.
...
func NewGetVMConfig200ResponseDataVirtio0() *GetVMConfig200ResponseDataVirtio0 {
	this := GetVMConfig200ResponseDataVirtio0{}
	return &this
}
...
func (o GetVMConfig200ResponseDataVirtio0) MarshalJSON() ([]byte, error) {
...
func (o GetVMConfig200ResponseDataVirtio0) ToMap() (map[string]interface{}, error) {
...
type NullableGetVMConfig200ResponseDataVirtio0 struct {
	value *GetVMConfig200ResponseDataVirtio0
	isSet bool
}

func (v NullableGetVMConfig200ResponseDataVirtio0) Get() *GetVMConfig200ResponseDataVirtio0 {
	return v.value
}

func (v *NullableGetVMConfig200ResponseDataVirtio0) Set(val *GetVMConfig200ResponseDataVirtio0) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVMConfig200ResponseDataVirtio0) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVMConfig200ResponseDataVirtio0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVMConfig200ResponseDataVirtio0(val *GetVMConfig200ResponseDataVirtio0) *NullableGetVMConfig200ResponseDataVirtio0 {
	return &NullableGetVMConfig200ResponseDataVirtio0{value: val, isSet: true}
}

func (v NullableGetVMConfig200ResponseDataVirtio0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVMConfig200ResponseDataVirtio0) UnmarshalJSON(src []byte) error {
	v.isSet = true
