...
// checks if the UpdateVMConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateVMConfigRequest{}
...
func (o *UpdateVMConfigRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUpdateVMConfigRequest := _UpdateVMConfigRequest{}

	err = json.Unmarshal(bytes, &varUpdateVMConfigRequest)

	if err != nil {
		return err
	}

	*o = UpdateVMConfigRequest(varUpdateVMConfigRequest)

	return err
}

type NullableUpdateVMConfigRequest struct {
	value *UpdateVMConfigRequest
	isSet bool
}

func (v NullableUpdateVMConfigRequest) Get() *UpdateVMConfigRequest {
	return v.value
}

func (v *NullableUpdateVMConfigRequest) Set(val *UpdateVMConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateVMConfigRequest) IsSet() bool {
	return v.isSet
}
...
func NewNullableUpdateVMConfigRequest(val *UpdateVMConfigRequest) *NullableUpdateVMConfigRequest {
	return &NullableUpdateVMConfigRequest{value: val, isSet: true}
}
